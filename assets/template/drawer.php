    ...
    <div class="l-inner p-drawer-menu__inner">
        <ul class="p-drawer-menu__lists">
            <li class="p-drawer-menu__list">
                <a href="<?php echo home_url('/'); ?>" class="p-drawer-menu__link">
            ...
            <li class="p-drawer-menu__list">
                ...
                <a href="<?php echo esc_url(get_permalink($page -> ID)); ?>" class="p-drawer-menu__link">
            ...
            <li class="p-drawer-menu__list">
                <a href="<?php echo esc_url(get_post_type_archive_link('blog')); ?>" class="p-drawer-menu__link">
