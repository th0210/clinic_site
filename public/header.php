        ...
        <header id="header" class="l-header">
            <?php if(is_front_page()): ?>
                <h1 class="l-header__logo">
                    <a href="<?php echo home_url('/'); ?>" class="l-header__logo__link"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/logo.png" alt="みなみ歯科クリニック"></a>
                </h1>
            <?php else: ?>
            ...
            <div class="l-header__logo__drawer">
                <a href="<?php echo home_url('/'); ?>" class="l-header__logo__drawer__link"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/logo-drawer.svg" alt=""></a>
            </div>
