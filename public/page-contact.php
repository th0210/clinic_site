        ...
        <div class="p-contact">
            <div class="p-contact__inner">
                <p class="p-contact__message">
                    お急ぎの方は、お電話(TEL 03-1234-5678)での連絡がスムーズです。 以下のフォームからお問い合わせ頂いた場合、ご連絡が2～3日後になる場合がございます。 
                ...
                <div class="u-text-align-center">
                    <h2 class="c-section-title p-contact__title">お問い合わせ<br class="u-sp-display">フォーム</h2>
                </div>
                <div class="p-form">
                    <?php echo do_shortcode('[contact-form-7 id="136" title="コンタクトフォーム"]'); ?>
                </div>
            </div>
        </div>
