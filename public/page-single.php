<?php get_header(); ?>
        ...
        <div class="p-mv">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/archive_top@2x.png" alt="">
        ...
        <div class="p-article">
            <div class="p-article__wrapper">
                <?php if(have_posts()): ?>
                    ...
                    <?php endwhile; ?>
                <?php endif; ?>                    
                    <div class="p-pagination-article">
                        <?php if (get_previous_post()): ?>
                            <div class="p-pagination-article__prev">
                                <?php previous_post_link('%link','前の記事へ', FALSE); ?>
                            </div>
                        <?php endif; ?>
                        <div class="p-pagination-article__all">
                            <a href="" class="p-pagination-article__all__link">記事一覧</a>
                        </div>
                        <?php if(get_next_post()) :?>
                            <div class="p-pagination-article__next">
