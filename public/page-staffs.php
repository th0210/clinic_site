<?php get_header(); ?>
        <div class="p-drawer-menu">
            <div class="l-inner p-drawer-menu__inner">
                <ul class="p-drawer-menu__lists">
                    <li class="p-drawer-menu__list">
                        <a href="" class="p-drawer-menu__link">
                            ...
                            <p class="p-drawer-menu__text">ホーム</p>
                        </a>
                    </li>
                    <li class="p-drawer-menu__list">
                        <a href="" class="p-drawer-menu__link">
                            <svg id="icon-02" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            ...
                            <p class="p-drawer-menu__text">当院について</p>
                        </a>
                    </li>
                    <li class="p-drawer-menu__list">
                        <a href="" class="p-drawer-menu__link">
                            ...
                            <p class="p-drawer-menu__text">診療案内</p>
                        </a>
                    </li>
                    <li class="p-drawer-menu__list">
                        <a href="" class="p-drawer-menu__link">
                            ...
                            <p class="p-drawer-menu__text">スタッフ紹介</p>
                        </a>
                    </li>
                    <li class="p-drawer-menu__list">
                        <a href="" class="p-drawer-menu__link">
                            ...
                            <p class="p-drawer-menu__text">スタッフブログ</p>
                        </a>
                    </li>
                    <li class="p-drawer-menu__list">
                        <a href="" class="p-drawer-menu__link">
                            ...
                            <p class="p-drawer-menu__text">お問い合わせ</p>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="p-mv">
            <img src="/assets/img/page-staff_top@2x.png" alt="">
                    ...
                    <div class="p-greeting__wrapper">
                        <div class="p-greeting__content">
                            ...
                            <div class="p-greeting__img__sp">
                                <img src="./assets/img/staff1@2x.png" alt="">
                            </div>
            ...
            <div class="p-staff-gallery">
                <ul class="p-staff-gallery__lists">
                    <li class="p-staff-gallery__list">
                        <img src="./assets/img/staff-slider1@2x.png" alt="">
                    </li>
                    <li class="p-staff-gallery__list">
                    ...
                    <li class="p-staff-gallery__list">
                        <img src="./assets/img/staff-slider1-3@2x.png" alt="">
                    </li>
                    <li class="p-staff-gallery__list">
                        <img src="./assets/img/staff-slider1-4@2x.png" alt="">
                    </li>
                </ul>
                <ul class="p-staff-gallery__lists">
                    <li class="p-staff-gallery__list">
                    ...
                    <li class="p-staff-gallery__list">
                        <img src="./assets/img/staff-slider1-1@2x.png" alt="">
                    </li>
                    <li class="p-staff-gallery__list">
                        <img src="./assets/img/staff-slider1-2@2x.png" alt="">
                    </li>
                    <li class="p-staff-gallery__list">
                        <img src="./assets/img/staff-slider1-3@2x.png" alt="">
                    </li>
                        ...
                        <div class="p-staff__wrapper1">
                            <div class="p-staff-card">
                                <div class="p-staff-card__img">
                                    <img src="./assets/img/staff2@2x.png" alt="">
                                </div>
                                <div class="p-staff-card__info">
                                    <p class="p-staff-card__job">歯科衛生士</p>
                                    <p class="p-staff-card__name">鈴木 太郎</p>
                                </div>
                            ...
                            <div class="p-staff-card">
                                <div class="p-staff-card__img">
                                    <img src="./assets/img/staff3@2x.png" alt="">
                                </div>
                                <div class="p-staff-card__info">
                                    <p class="p-staff-card__job">歯科衛生士</p>
                                    <p class="p-staff-card__name">山田 花子</p>
                                </div>
                                <div class="p-staff-card__detail">
                                    <dl class="p-staff-table">
                                        <div class="p-staff-table__item">
                    ...
                    <div class="p-staff__row">
                        ...
                        <div class="p-staff__wrapper2">
                            <div class="p-staff-card grid">
                                <div class="p-staff-card__img">
                                    <img src="./assets/img/staff4@2x.png" alt="">
                                </div>
                                <div class="p-staff-card__info">
                            ...
                            <div class="p-staff-card grid">
                                <div class="p-staff-card__img">
                                    <img src="./assets/img/staff5@2x.png" alt="">
                                </div>
                                <div class="p-staff-card__info">
                                    <p class="p-staff-card__job">歯科助手</p>
                                    <p class="p-staff-card__name">山田 花子</p>
                            ...
                            <div class="p-staff-card grid">
                                <div class="p-staff-card__img">
                                    <img src="./assets/img/staff6@2x.png" alt="">
                                </div>
                                <div class="p-staff-card__info">
                                    <p class="p-staff-card__job">歯科助手</p>
                                    <p class="p-staff-card__name">山田 花子</p>
                            ...
                            <div class="p-staff-card grid">
                                <div class="p-staff-card__img">
                                    <img src="./assets/img/staff7@2x.png" alt="">
                                </div>
                                <div class="p-staff-card__info">
                                    <p class="p-staff-card__job">歯科助手</p>
                                    <p class="p-staff-card__name">山田 花子</p>
                            ...
                            <div class="p-staff-card grid">
                                <div class="p-staff-card__img">
                                    <img src="./assets/img/staff8@2x.png" alt="">
                                </div>
                                <div class="p-staff-card__info">
                                    <p class="p-staff-card__job">歯科助手</p>
                                    <p class="p-staff-card__name">山田 花子</p>
